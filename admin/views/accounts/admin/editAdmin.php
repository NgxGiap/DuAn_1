                ...
                <div class="col-12">
                    <div class="card card-primary">
                        <div class="card-header">
                            <h3 class="card-title">Sửa tài khoản Admin: <?= $Admin['Username'] ?> </h3>
                        </div>
                        <!-- /.card-header -->
                        <!-- form start -->
                        <form action="<?= BASE_URL_ADMIN . '?act=edit-admin' ?>" method="POST">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group col-12">
                                    <label>Email</label>
                                    <input type="email" class="form-control" value="<?= $Admin['Email'] ?>" name="Email" placeholder="Nhập email">
                                ...
                                <div class="form-group col-12">
                                    <label>Họ tên</label>
                                    <input type="text" class="form-control" value="<?= $Admin['FullName'] ?>" name="FullName" placeholder="Nhập họ tên">
                                ...
                                <div class="form-group col-12">
                                    ...
                                    <input type="text" class="form-control" value="<?= $Admin['Phone'] ?>" name="Phone" placeholder="Nhập số điện thoại">
