...
--
-- Host: localhost:3306
-- Generation Time: Nov 17, 2024 at 07:19 AM
...
INSERT INTO `product` (`ProductID`, `ProductName`, `Image`, `Description`, `Price`, `StockQuantity`, `BrandID`, `Color`, `Storage`, `Size`, `CategoryID`, `SKU`) VALUES
...
--
ALTER TABLE `category`
  ADD CONSTRAINT `catogory_product` FOREIGN KEY (`id`) REFERENCES `product` (`ProductID`) ON DELETE RESTRICT ON UPDATE RESTRICT;
